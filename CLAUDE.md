...
## Project specifics: agentic-adlib-gold

Everything above is the shared spine, copied verbatim at the adopted revision.
This section records what is particular to this project, and an upgrade leaves it
alone.

This host governs one piece of software, recorded in `.host-software`.

- **The software (Where room).** `adlib_gold`
  (`https://github.com/slartibardfast/adlib_gold`) is a Windows WDM audio driver
  in C++ for the Ad Lib Gold sound card, bundled with the v1.01 Developer Toolkit
